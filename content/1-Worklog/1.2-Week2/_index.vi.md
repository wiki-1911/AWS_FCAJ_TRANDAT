...
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ---------- | ------------------------------------------------------------------------ |
| 1    | Tham gia buổi học trực tiếp đầu tiên tại văn phòng và nhận hướng dẫn từ mentor.                                                               | 11/05/2026 | 11/05/2026 | Văn phòng công ty                                                        |
...
- Đăng ký và cấu hình thành công tài khoản AWS.
- Hoàn thành đầy đủ 5 bài thực hành làm quen với các dịch vụ AWS.
- Hiểu được chức năng và mục đích sử dụng của các dịch vụ:
  - Amazon EC2
  - Amazon Bedrock
  - Amazon Aurora
  - Amazon RDS
...
- Hoàn thành Module 1 (Bài 1.1 – 1.7).
- Biết cách theo dõi và tối ưu chi phí sử dụng dịch vụ thông qua Billing & Cost Management.
- Nắm được các khái niệm cơ bản của AWS Identity and Access Management (IAM).
- Thực hành quản lý người dùng, phân quyền và bảo mật truy cập vào tài nguyên AWS.
- Xây dựng nền tảng kiến thức để tiếp tục các nội dung về mạng và hạ tầng AWS trong các tuần tiếp theo.
