...
| --- | ------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------- | ------------------------------------------------------------------------ |
| 1   | Attend the first on-site training session and receive guidance from mentors.                                                    | 11/05/2026 | 11/05/2026      | Company Office                                                           |
...
- Completed all five introductory AWS practice tasks.
- Gained an understanding of the following AWS services:
  - Amazon EC2
  - Amazon Bedrock
  - Amazon Aurora
  - Amazon RDS
...
- Successfully completed Module 1 (Lessons 1.1 – 1.7).
- Learned how to monitor and optimize AWS service costs using Billing & Cost Management.
- Understood the basic concepts of AWS Identity and Access Management (IAM).
- Practiced managing users, permissions, and secure access to AWS resources.
- Built a solid foundation for the networking and infrastructure topics in the following modules.
